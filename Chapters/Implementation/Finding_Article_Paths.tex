...
Finding full paths of all articles require information about Wikipedia's structure between categories, and between categories and articles. This, the first step was to create a way of representing the available information about the Wkipedia structure. % so the relevant information could be extracted. 
